...
export async function runAudit({ url, html, mode = 'page', componentType = 'auto', model = 'sonnet' }, emitter) {
  ...
  try {
    ...
    const claudeRaw = await analyzeWithClaude(pageHtml, { mode, componentType, model })
